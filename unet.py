...
for i, image_name in enumerate(images):  
   if image_name.endswith(".png"):                   
    ...
    #    print("Image Size after resizing:", image.size)  # Print resized image size
...
for i, mask_name in enumerate(masks):  
    if mask_name.endswith(".png"):                  
        ...
        print("Mask Size after resizing:", mask.size)  # Print resized mask size

        mask = np.array(mask)
        print("Mask array shape:", mask.shape)
